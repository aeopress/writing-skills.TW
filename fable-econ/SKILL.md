...
- ❌ **揭曉段收金句**：結尾補一句「而這，正是市場真正的語言」「注意力才是唯一的貨幣」式可轉發警句——新一代模型的高頻 tell。揭曉段以「解釋＋故事對映」收尾，不以格言收尾；標竿範例最後一句是機制的現實應用，不是警句
- ❌ **短句連發造勢**：「沒有人停下。沒有人回頭。一切都變了。」——反轉的力量來自事實對比（標竿範例用的是 3:1 vs 2:1），不是斷句堆疊出來的戲劇腔。§ 3 允許一句短句收束，連發即失敗
- ❌ **假深刻結語**：「說到底，這是一個關於信任的故事」「真正的問題從來不是價格」——裝作戳破表象的框架句。刪掉，直接講機制
